...
class Pinterest {
  ...
  async search(query, limit = 10) {
    ...
    try {
      ...
      const {
        data
      } = await axios.get(`${this.api.base}${this.api.endpoints.search}`, {
        headers: {
          ...this.headers,
          cookie: cookies
        },
  ...
  async download(pinUrl) {
    ...
    try {
      ...
      const {
        data
      } = await axios.get(`${this.api.base}${this.api.endpoints.pin}`, {
        headers: {
          ...this.headers,
          cookie: cookies
        },
  ...
  async profile(username) {
    ...
    try {
      ...
      const {
        data
      } = await axios.get(`${this.api.base}${this.api.endpoints.user}`, {
        headers: {
          ...this.headers,
          cookie: cookies
        },
